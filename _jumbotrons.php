...
$pagename = "Jumbotrons Examples Lorem Ipsum Lab Home";  // Title of this page (appears in tab of web browser)
$pagedescription = "Jumbotrons Examples: The Lorem Ipsum Lab takes samples and researches them.";  // Description of this page (appears in search engines)
